...
export const AREAS: AreaDef[] = [
  ...
  },
  {
    ...
    hint: "the second monitor is waiting with a blank canvas",
    stars: 3,
    coins: 4,
    x: 78,
    y: 16,
...
export const ACHIEVEMENTS: AchievementDef[] = [
  ...
  { id: "maximum-sparkle", title: "Maximum Sparkle", description: "So sparkly the stars got jealous.", icon: "💅" },
  { id: "pool-menace", title: "Pool Menace", description: "Still suspiciously good at pool.", icon: "🎱" },
  { id: "future-nurse", title: "Future Nurse", description: "Kindness stat: completely overflowing.", icon: "🩺" },
