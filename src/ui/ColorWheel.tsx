...
export function ColorWheel({
  ...
  return (
    <div ref={wrapRef} className="relative">
      ...
      {open && (
        <div className="absolute bottom-[calc(100%+0.55rem)] right-0 z-[70] w-[11.5rem] rounded-[1.2rem] border-[1.5px] border-ink/10 bg-white p-3 shadow-[0_18px_30px_-16px_rgba(91,68,80,0.85)] sm:left-0 sm:right-auto">
          <p className="mb-2 font-hand text-sm">color wheel</p>
          <div
            ref={wheelRef}
            role="slider"
            aria-label="hue and saturation"
            className="relative mx-auto h-[8.2rem] w-[8.2rem] cursor-crosshair touch-none rounded-full"
            style={{
              background: `
