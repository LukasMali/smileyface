...
function AwakeNikki({
  ...
  const wag = animated && pose !== "stretch"
  const lean = pose === "stretch" ? "rotate(-8 100 120)" : pose === "spin" ? "rotate(7 100 120)" : undefined
  ...
  return (
    <g>
      ...
      <g className={animated ? "anim-breathe" : undefined} transform={lean} style={{ transformOrigin: "100px 150px" }}>
        {/* body */}
        <FurBlob cx={100} cy={148} rx={38} ry={30} lobes={13} bulge={0.11} seed={3} fill={coat} />
        {/* cream chest bib */}
